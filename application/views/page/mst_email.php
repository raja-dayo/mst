	...
	<tbody>
		<tr>
			...
			<div style="margin-bottom:20px; padding:20px 0px; border-bottom:1px solid #eeeeee"><a href="index.html">
				...
				<p style="font-size:16px; line-height:20pt; font-weight:bold;">Hi <?php echo $orderInfo[0]['od_s_fname']." ".$orderInfo[0]['od_s_lname']?>,</p>
				<p style="font-size:16px; line-height:20pt;">Thanks for your order. <?="It’s"?> on-hold until we confirm that payment has been received.</p>
				<p style="font-size:16px; line-height:20pt;">If you haven't received the payment details, please coordinate with us on <a href="mailto:orders@mysleepingtabs.com" style="color:#077dd5;">orders@mysleepingtabs.com</a> or check below</p>
				...
				<h2 style="display:block; font-size:20px; margin:30px 0 10px 0; text-align:left; color:#067dd6;">
				   Order # <?php echo $orderInfo[0]['od_id'];?> <span style="font-size:14px; color:#666; font-weight:normal;">(<?php echo $orderInfo[0]['od_create_on']; ?>)</span>
				</h2>
				<table cellspacing="0" cellpadding="6" style="color:#666666; width:100%; vertical-align:middle;  border:solid 1px #ccc;">
							...
							foreach ($orderInfo as $key => $od) 
							{
								?>
									...
									<tr>
										...
										<td style=" border-bottom:1px solid #ebebeb;text-align:right;padding:10px;"><?php echo $_SESSION['sign'].$od['qty']*$od['pro_price']?></td>
									</tr>
								<?php
							}
						?>
					...
					<tbody style="background: #f3f3f3;">
						<tr>
							...
							<td style="text-align:left; border-top-width:0px; vertical-align:middle;text-align:right;border-bottom:1px solid #dedede;"><?php echo $_SESSION['sign'].$orderInfo[0]['od_total'];?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="text-align:right;border-bottom:1px solid #dedede;"><?php echo $_SESSION['sign'].($orderInfo[0]['od_total']+$orderInfo[0]['od_d_charge']);?></td>
						</tr>
					</tbody>
					...
					<tbody style=" color:#666666; width:100%; vertical-align:top; margin-bottom:20px; padding:10px 0 20px 20px; background:#f3f3f3;">
						<tr>
							<td colspan="2" style="text-align:left;  border:0; padding:10px;" valign="top" width="50%">
								...
								<address><?php echo $_SESSION['cus']['info']['cus_fname']." ".$_SESSION['cus']['info']['cus_lname']?><br><?php echo $_SESSION['cus']['info']['cus_add']?><br><?php echo $_SESSION['cus']['info']['cus_city']." ".$_SESSION['cus']['info']['cus_state']." ".$_SESSION['cus']['info']['cus_zipcode']." ,".$_SESSION['cus']['info']['cus_country']?></p>
								</address>
							</td>
